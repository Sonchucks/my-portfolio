...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'A web application that allows users to collaboratively create themed maps which list multipled markers following that theme. For example "Best places to eat in downtown Montreal"',
        technologies: [
            'PostgreSQL',
            'knex',
            'ExpressJS',
    ...
    },
    {
        ...
        description: 'A mini e-commerce application which allows uers to view and purchase products with Stripe verification.'
    ...
    },
    {
        ...
        description: 'Small project to tryout NextJS and complemetary libraries. Create a round robin tournament and view/update matches for each round. Also has a view for team standings.',
        technologies: [
            'NextJS',
            'TailwindCSS',
            'SQLite',
